...
Also, we leave our activities, preferences, and personal information in a variety of places, both online and offline. Companies can collect personal data from a variety of sources and know detailed profiles based on an individual’s preferences and other attributes.

 **What is their intention to collect our data?**
There are **two main reasons** to collect our data. The first is to **maintain and improve their services** that they provide to users. Secondly, to **personalise advertising and contact for users**.
Technology companies can offer personalised advertising by using collecting data. Collecting data has an important role in business. The data which they collect can be used to improve their strategies and generate new profits.
