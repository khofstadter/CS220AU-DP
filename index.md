...
1. who is the target audience?
   1. my CS220 students
   2. colleagues at Essex
   3. a wider audience (e.g. academics interested in teaching methods)
2. can I survey previous students and incorporate findings?
3. see tasks in HTML comments below
-->

# How to Lin Digital Identities to Existential Risks?
...
Feedback from students was positive, so the 2023 assignment brief was to look at the connections between DIs and ERs again, but this year, everyone had to<!-- change to had to later--> focus on **one** specific connection to reflect on using their websites.

After outlining how the module 'evolved in my hands', I will 
1. briefly discuss how using ideas from Agile Project Management (APM) aims to help students progress with their assignments and then
