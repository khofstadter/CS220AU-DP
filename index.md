...
By agreeing to these, big tech companies can collect data as wide-ranging as our location, personal information, search history, online purchase history, and emails that have been sent and received. The data companies are collecting is **not only personal data such as name, date of birth, and email address but may also use image recognition and voice recognition to capture a user's appearance**. 

According to [Clario](https://clario.co/blog/which-company-uses-most-data/), Airbnb, Instagram, Meta, and TikTok have the option to store photos of faces. Additionally, Twitter, Spotify, and Clubhouse, among others, use voice recognition. These image and voice recognition requires access to the entire image libraries within the app, and accessing them can provide personalised advertising that is more tailored to the user's interests and behaviour. Major social media platforms such as Snapchat and Instagram track location and contact information across apps; Apple consistently tracks user location and contact information throughout apps such as Safari, Photos, Weather, Maps, and Messages. While it is also possible for users to refuse such location information, many apps ask for permission to track their exact location through the mobile phone's global positioning system. However, even if you refuse the app's permission, the app can still learn your location. For example, Facebook collects location-related data apart from the mobile phone's GPS, and these data can track a user's whereabouts through their IP address. In addition, Twitter 'requests' information about the user's current location. This information is obtained from signals such as IP addresses and device settings.[^6] Companies can use such location data to learn about income levels, the user's current location, school or workplace and shopping habits.
### How do they collect users' data?
According to the Harvard Business School online, there are seven data collection methods used in business analysis; surveys, transactional tracking, interviews and focus groups, observation, online tracking, forms, and social media monitoring.[^9] Surveys can be physical or digital and collect both qualitative and quantitative data on the target audience. Transaction tracking tracks data on every purchase a customer makes, allowing decisions to be made about targeted marketing activities and a better understanding of the customer base. In e-commerce, data can be stored as soon as it is generated, making it a seamless method of data collection. Interviews and focus groups consist of face-to-face talking to the target about a specific topic or issue. This, like surveys, allows companies to get the information they want from their customers and collects both qualitative and quantitative data. Companies also collect our data by us agreeing to their privacy policies and cookies as indicated above. Also, we leave our activities, preferences, and personal information in a variety of places, both online and offline. Companies can collect personal data from a variety of sources and know detailed profiles based on an individual’s preferences and other attributes. 

 ### What is their intention to collect our data?
How such data is used depends on the type of business. There are **two main reasons** to collect our data. The first is to **maintain and improve their services** that they provide to users. Secondly, to **personalise advertising and contact for users**. Technology companies can offer personalised advertising by using collecting data. Collecting data has an important role in business. The data which they collect can be used to improve their strategies and generate new profits. For example, Google collects and stores most of our data because it depends on knowing as much as possible to make access easier. So, in other words, our benefit as individuals receive from companies collecting our data is that we can get personalised advertising that is appropriate for each user, making it easier for us to get information on what we are interested in. The benefit for all users is that we will always have access to better websites and platforms.  
...
>As well as using complex language, the BBC found that reading the terms of 15 popular sites would take almost nine hours in total.[^7]
...
[^1]: Clark, K., Duckham, M., Guillemin, M., Hunter, A., McVernon, J., O’Keefe, C., Pitkin, C., Prawer, S., Sinnott, R., Warr, D. & Waycott, J. (2018). Advancing the ethical use of digital data in human research: challenges and strategies to promote ethical practice. Ethics and Information Technology, 21(1), pp.59–73. doi:https://doi.org/10.1007/s10676-018-9490-4
...
[^9]: Cote, C. (2021). [7 Data Collection Methods in Business Analytics](https://online.hbs.edu/blog/post/data-collection-methods). Harvard Business School.
‌
‌
‌
